...
const dressImages = [
    'Gemini_Generated_Image_1ifv551ifv551ifv.png',
    'Gemini_Generated_Image_4g2iqz4g2iqz4g2i.png',
    'Gemini_Generated_Image_73qkoj73qkoj73qk.png',
    'Gemini_Generated_Image_8ghmpe8ghmpe8ghm.png',
    'Gemini_Generated_Image_8tt2gg8tt2gg8tt2.png',
    'Gemini_Generated_Image_9tutw99tutw99tut.png',
    'Gemini_Generated_Image_a6r4ssa6r4ssa6r4.png',
    'Gemini_Generated_Image_at7oz4at7oz4at7o.png',
    'Gemini_Generated_Image_fvmd7kfvmd7kfvmd.png',
    'Gemini_Generated_Image_ggm5sbggm5sbggm5.png',
    'Gemini_Generated_Image_l1v6y2l1v6y2l1v6.png',
    'Gemini_Generated_Image_qh3xiaqh3xiaqh3x.png',
    'Gemini_Generated_Image_tiz7eitiz7eitiz7.png',
    'Gemini_Generated_Image_tuq355tuq355tuq3.png',
    'Gemini_Generated_Image_uw84bouw84bouw84.png',
    'Gemini_Generated_Image_vva5vfvva5vfvva5.png',
    'Gemini_Generated_Image_x8bjapx8bjapx8bj.png',
    'Gemini_Generated_Image_zezygvzezygvzezy.png'
];
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Liga os botões de tema, restaura tema salvo
    initializeThemeSwitcher();
    
    // Define altura dinâmica do header para posicionar o letreiro corretamente
...
function clearThemes() {
    document.body.classList.remove('theme-blackfriday', 'theme-natal');
...
function applyTheme(theme) {
    ...
    if (theme === 'blackfriday') {
        ...
        // Tema padrão - não faz nada, apenas limpa
    }
...
function openLoginModal() {
    ...
    document.body.style.overflow = 'hidden';
    setTimeout(() => modal.classList.add('visible'), 10);
    window.addEventListener('keydown', escCloseLogin);
    modal.addEventListener('click', outsideCloseLogin);
}
function closeLoginModal() {
    ...
    window.removeEventListener('keydown', escCloseLogin);
    modal.removeEventListener('click', outsideCloseLogin);
}
function escCloseLogin(e) {
    if (e.key === 'Escape') closeLoginModal();
}
function outsideCloseLogin(e) {
...
function addSnow() {
    ...
    const flakes = 200; // Aumentado de 120 para 200
    
    for (let i = 0; i < flakes; i++) {
        const s = document.createElement('span');
        s.className = 'snowflake';
        const size = Math.random() * 5 + 2; // 2px - 7px (aumentado)
        const left = Math.random() * 100;   // vw
        const fallDur = (5 + Math.random() * 12).toFixed(2); // 5s - 17s
        const delay = (Math.random() * 10).toFixed(2);
        const swayAmount = (Math.random() * 40 - 20).toFixed(2); // -20px a 20px
    ...
    document.body.appendChild(container);
    console.log('Flocos de neve adicionados:', flakes);
}